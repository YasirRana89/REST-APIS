...
class BlogPost
{
    ...
    function insertPost(){
        ...
        " . $this->table_name . "
     SET
     category_id=:category_id,username=:username,url=:url,caption=:caption,post_id=:post_id, user_id=:user_id, post_title=:post_title, 
     post_description=:post_description, created_at=:created_at, updated_at=:updated_at,created_by=:created_by,
     updated_by=:updated_by, email=:email";
        // prepare query
        ...
        // $imageName = str_repeat("-",$image_name).'-'.time() . '.png';
        // $imagePath = '/uploads/images/'.$imageName;
        // //$imageUrl = 'http://mufassirislam.com/apps/blog/uploads/images/'.$imageName;
